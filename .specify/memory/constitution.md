...
Solo se construye lo que define el alcance del MVP: autenticación con Laravel
Breeze (correo y contraseña) y Laravel Socialite (Google como único proveedor
OAuth), CRUD de proyectos con métricas de avance, sprints con
...
- Autenticación: Laravel Breeze para el login tradicional (correo y
  contraseña) y Laravel Socialite para OAuth con proveedor Google únicamente;
  GitHub no está habilitado. No se añaden más proveedores ni flujos de
  autenticación sin enmienda constitucional.
